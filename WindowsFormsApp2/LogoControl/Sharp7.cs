...
namespace Sharp7
{
        ...
        private int WaitForData(int Size, int Timeout)
        {
            ...
            try
            {
                ...
                while ((SizeAvail < Size) && (!Expired))
                {
                    ...
                    if (!WindowsFormsApp2.Settings.EnableHighPerformanceSync)
                    {
    ...
    public static class S7Consts
    {
        ...
        //                                     ERRORS                 
        //------------------------------------------------------------------------------
        public const int err_UnspecifiedHigherLayer   = -100;   // added later by Humar Sistemi
        public const int err_cantConnect              = -8;     // added later by Humar Sistemi
        public const int err_typeError                = -7;     // added later by Humar Sistemi
        public const int err_WriteHigherLayer         = -6;    // added later by Humar Sistemi
        public const int err_ReadHigherLayer          = -5;    // added later by Humar Sistemi
        public const int err_Write                    = -4;     // added later by Humar Sistemi
        public const int err_Read                     = -3;     // added later by Humar Sistemi
        public const int err_watchdogDoesntChange     = -2;     // added later by Humar Sistemi

        public const int err_OK                       = 0;      // added later by Humar Sistemi
